...
function PostCard({ post, author, sanity }) {
    ...
    const authorAvatar = sanity ? author?.avatar ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sanity$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["urlFor"])(author.avatar).width(64).height(64).url() : null : author?.avatar;
    ...
    const imageUrl = sanity ? post.mainImage ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sanity$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["urlFor"])(post.mainImage).width(600).height(400).url() : post.mainImageUrl ? cleanWixUrl(post.mainImageUrl) : null : post.image;
    const fmtDate = (d)=>{
        try {
...
_s(NewsletterSection, "ffAIXBwfFgeXe4+0Oq7fjPrxFy0=");
...
//# sourceMappingURL=components_18jk0oh._.js.map